...
async function verifyEmail({ token }) {
  ...
  console.log(
    `Current account state: verified=${account.verified}, verificationToken=${account.verificationToken}`
  );
  ...
  try {
    ...
    console.log(
      `Verified status after save: email=${verifiedAccount.email}, verified=${verifiedAccount.verified}, verificationToken=${verifiedAccount.verificationToken}`
    );
...
async function sendVerificationEmail(account, origin) {
  ...
  const backendUrl = "https://user-management-system-dfdu.onrender.com";
  const verifyUrl = `${backendUrl}/accounts/verify-email?token=${
